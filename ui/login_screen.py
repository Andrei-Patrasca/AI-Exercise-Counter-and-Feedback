...
class LoginScreen(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkLabel(card, text="Sign in to your account",
                     font=FONT_BODY,
                     text_color=COLORS["text_sub"]).pack(pady=(0, 24))
        ...
        self.login_btn = ctk.CTkButton(
            card, text="Sign In", width=320, height=44,
            font=FONT_H3, command=self._login,
        ...
        # Register button
        ctk.CTkButton(
            card, text="Create an account", width=320, height=44,
            font=FONT_BODY, command=self.on_go_to_register,
