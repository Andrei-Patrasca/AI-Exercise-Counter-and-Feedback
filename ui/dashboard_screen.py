...
class DashboardScreen(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkButton(
            top, text="Logout", width=100, height=34,
            font=FONT_SMALL, command=self.on_logout,
        ...
        ctk.CTkLabel(inner, text="FitTrack",
                     font=FONT_TITLE,
                     text_color=COLORS["accent"]).pack(pady=(0, 8))
        ctk.CTkLabel(inner, text="Track your reps. Build your strength.",
                     font=FONT_BODY,
                     text_color=COLORS["text_sub"]).pack(pady=(0, 40))
        ...
        ctk.CTkButton(
            inner, text="⚙️   Account Settings",
            width=360, height=52,
            font=FONT_H3,
            command=self.on_account_settings,
            fg_color="transparent",
            border_width=1,
            border_color=COLORS["accent"],
            text_color=COLORS["accent"],
